...
\begin{tikzpicture}
    ...
    \addplot[domain=22:\Ka,<-, dotted]{\Pa*100};
    \addplot[domain=\Ka:40,->, dotted]{(\Pa+\Ka-x)*100};

    \addplot[domain=22:\Kb,<-, dotted]{-\Pb*100};
    \addplot[domain=\Kb:40,->, dotted]{(x-\Kb-\Pb)*100};
    % \addplot[domain=\Ka:37,->, dotted]{(x-\Ka-\Pa)*100};
